...
class InsurancePricingModel:
    ...
    def predict_with_factors(
        ...
        if (
            ...
            and self.feature_processor.feature_names
        ):
            ...
            for i in range(len(policies)):
                ...
                driver_contribution = sum(
                    contributions[j]
                    for j, name in enumerate(self.feature_processor.feature_names)
                ...
                location_contribution = sum(
                    ...
                    or name in ["crime_rate", "weather_risk", "traffic_density"]
                )
    ...
    def calculate_premium(
        ...
        if apply_factors and policy.pricing_factors:
            ...
            if policy.pricing_factors.credit_score:
                credit_factor = self._calculate_credit_factor(
            ...
            final_premium = (
                base_premium * credit_factor * insurance_factor * territory_factor
            )
        else:
