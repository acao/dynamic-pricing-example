...
class AdvancedDriverFeatureExtractor(DriverFeatureExtractor):
    ...
    def transform(self, X: List[Driver]) -> pd.DataFrame:
        ...
        for i, driver in enumerate(X):
            ...
            age = driver.age
            age_risk = self.age_risk_curve.get(
                age, 1.5
            )  # Default to high risk if age is out of range
            features_df.at[i, "age_risk_factor"] = age_risk

            # Experience risk factor (exponential decay)
            experience = driver.driving_experience
            exp_risk = self.experience_risk_curve.get(
                experience, 1.5
            )  # Default to high risk if experience is out of range
            ...
            license_recency = (
                (driver.age - driver.driving_experience) / driver.age
                if driver.age > 0
                else 1.0
            )
            ...
            features_df.at[i, "age_experience_ratio"] = driver.age / max(
                1, driver.driving_experience
            )
...
class AdvancedVehicleFeatureExtractor(VehicleFeatureExtractor):
    ...
    def _create_value_depreciation_curve(self) -> Dict[int, float]:
        ...
        for age in range(4, 10):
            depreciation_curve[age] = 0.65 - 0.025 * (
                age - 3
            )  # Decreasing from 0.65 to 0.475

        # Older vehicles (slow depreciation)
        for age in range(10, 30):
            depreciation_curve[age] = 0.45 - 0.01 * (
                age - 10
            )  # Decreasing from 0.45 to 0.25
    ...
    def _create_mileage_risk_curve(self) -> Dict[int, float]:
        ...
        for miles in range(0, 5001, 1000):
            risk_curve[miles] = 0.8 + 0.04 * (
                miles / 1000
            )  # Increasing from 0.8 to 1.0

        # Average mileage (medium risk)
        for miles in range(5001, 15001, 1000):
            risk_curve[miles] = 1.0 + 0.02 * (
                (miles - 5000) / 1000
            )  # Increasing from 1.0 to 1.2

        # High mileage (high risk)
        for miles in range(15001, 50001, 1000):
            risk_curve[miles] = 1.2 + 0.01 * (
                (miles - 15000) / 1000
            )  # Increasing from 1.2 to 1.55
    ...
    def _create_vehicle_category_map(self) -> Dict[str, Dict[str, Union[str, float]]]:
        ...
        # Toyota
        category_map["toyota_corolla"] = {
            "category": "economy",
            "risk_factor": 0.9,
            "theft_risk": 0.8,
        }
        category_map["toyota_camry"] = {
            "category": "standard",
            "risk_factor": 0.95,
            "theft_risk": 0.85,
        }
        category_map["toyota_rav4"] = {
            "category": "suv",
            "risk_factor": 1.0,
            "theft_risk": 0.9,
        }
        category_map["toyota_highlander"] = {
            "category": "suv",
            "risk_factor": 1.05,
            "theft_risk": 0.9,
        }
        category_map["toyota_tacoma"] = {
            "category": "truck",
            "risk_factor": 1.1,
            "theft_risk": 1.0,
        }
        ...
        # Honda
        category_map["honda_civic"] = {
            "category": "economy",
            "risk_factor": 0.9,
            "theft_risk": 1.0,
        }
        category_map["honda_accord"] = {
            "category": "standard",
            "risk_factor": 0.95,
            "theft_risk": 0.9,
        }
        category_map["honda_cr-v"] = {
            "category": "suv",
            "risk_factor": 1.0,
            "theft_risk": 0.85,
        }
        category_map["honda_pilot"] = {
            "category": "suv",
            "risk_factor": 1.05,
            "theft_risk": 0.9,
        }
        category_map["honda_odyssey"] = {
            "category": "van",
            "risk_factor": 1.0,
            "theft_risk": 0.8,
        }
        ...
        # Ford
        category_map["ford_focus"] = {
            "category": "economy",
            "risk_factor": 0.95,
            "theft_risk": 0.9,
        }
        category_map["ford_fusion"] = {
            "category": "standard",
            "risk_factor": 1.0,
            "theft_risk": 0.9,
        }
        category_map["ford_escape"] = {
            "category": "suv",
            "risk_factor": 1.05,
            "theft_risk": 0.95,
        }
        category_map["ford_explorer"] = {
            "category": "suv",
            "risk_factor": 1.1,
            "theft_risk": 1.0,
        }
        category_map["ford_f-150"] = {
            "category": "truck",
            "risk_factor": 1.15,
            "theft_risk": 1.1,
        }
        category_map["ford_mustang"] = {
            "category": "sports",
            "risk_factor": 1.4,
            "theft_risk": 1.2,
        }
        ...
        # Chevrolet
        category_map["chevrolet_spark"] = {
            "category": "economy",
            "risk_factor": 0.95,
            "theft_risk": 0.85,
        }
        category_map["chevrolet_malibu"] = {
            "category": "standard",
            "risk_factor": 1.0,
            "theft_risk": 0.9,
        }
        category_map["chevrolet_equinox"] = {
            "category": "suv",
            "risk_factor": 1.05,
            "theft_risk": 0.95,
        }
        category_map["chevrolet_tahoe"] = {
            "category": "suv",
            "risk_factor": 1.15,
            "theft_risk": 1.05,
        }
        category_map["chevrolet_silverado"] = {
            "category": "truck",
            "risk_factor": 1.2,
            "theft_risk": 1.1,
        }
        category_map["chevrolet_corvette"] = {
            "category": "sports",
            "risk_factor": 1.5,
            "theft_risk": 1.3,
        }
        ...
        # Luxury brands
        category_map["bmw_3series"] = {
            "category": "luxury",
            "risk_factor": 1.2,
            "theft_risk": 1.1,
        }
        category_map["bmw_5series"] = {
            "category": "luxury",
            "risk_factor": 1.3,
            "theft_risk": 1.15,
        }
        ...
        category_map["mercedes_cclass"] = {
            "category": "luxury",
            "risk_factor": 1.25,
            "theft_risk": 1.15,
        }
        category_map["mercedes_eclass"] = {
            "category": "luxury",
            "risk_factor": 1.35,
            "theft_risk": 1.2,
        }
        category_map["mercedes_glc"] = {
            "category": "luxury_suv",
            "risk_factor": 1.3,
            "theft_risk": 1.15,
        }
        category_map["mercedes_gle"] = {
            "category": "luxury_suv",
            "risk_factor": 1.4,
            "theft_risk": 1.25,
        }
        ...
        # Electric vehicles
        category_map["tesla_model3"] = {
            "category": "electric",
            "risk_factor": 1.15,
            "theft_risk": 1.0,
        }
        category_map["tesla_modely"] = {
            "category": "electric_suv",
            "risk_factor": 1.2,
            "theft_risk": 1.05,
        }
        category_map["tesla_models"] = {
            "category": "luxury_electric",
            "risk_factor": 1.3,
            "theft_risk": 1.1,
        }
        category_map["tesla_modelx"] = {
            "category": "luxury_electric_suv",
            "risk_factor": 1.35,
            "theft_risk": 1.15,
        }
    ...
    def transform(self, X: List[Vehicle]) -> pd.DataFrame:
        ...
        for i, vehicle in enumerate(X):
            ...
            vehicle_info = self.vehicle_category_map.get(
                make_model_key, self.vehicle_category_map["default"]
            )

            features_df.at[i, "vehicle_category"] = vehicle_info["category"]
            features_df.at[i, "category_risk_factor"] = vehicle_info["risk_factor"]
            features_df.at[i, "theft_risk_factor"] = vehicle_info["theft_risk"] * (
                0.7 if vehicle.anti_theft_device else 1.0
            )

            # Value depreciation
            depreciation_factor = self.value_depreciation_curve.get(
                vehicle.vehicle_age,
                0.25,  # Default to 25% of original value for very old vehicles
            )
            ...
            features_df.at[i, "value_age_ratio"] = vehicle.value / max(
                1, vehicle.vehicle_age
            )

            # Interaction features
            features_df.at[i, "value_mileage_factor"] = (vehicle.value / 10000) * (
...
class AdvancedLocationFeatureExtractor(LocationFeatureExtractor):
    ...
    def transform(self, X: List[Location]) -> pd.DataFrame:
        ...
        for i, location in enumerate(X):
            ...
            enhanced_territory = self._classify_enhanced_territory(
        ...
        class EnhancedPolicyExtractor(BaseEstimator, TransformerMixin):
            def __init__(self):
                ...
                self.history_extractor = (
                    super(EnhancedFeatureProcessor, self)
                    ._create_policy_extractor()
                    .history_extractor
                )
            ...
            def fit(self, X, y=None):
                ...
                all_histories = [
                    history for policy in X for history in policy.driving_history
                ]
                all_locations = [
                    location for policy in X for location in policy.locations
                ]
            ...
            def transform(self, X):
                ...
                for policy in X:
                    ...
                    history_features = self.history_extractor.transform(
                        policy.driving_history
                    )
                    location_features = self.location_extractor.transform(
                        policy.locations
                    )
                    ...
                    for col in driver_features.columns:
                        if driver_features[col].dtype in [np.float64, np.int64]:
                            driver_agg[f"driver_{col}_mean"] = driver_features[
                                col
                            ].mean()
                            ...
                            driver_agg[f"driver_{col}_mode"] = driver_features[
                                col
                            ].mode()[0]
